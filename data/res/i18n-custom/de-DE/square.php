...
return array(
    ...
    'This time slot is in the past' => 'Buchung liegt in der Vergangenheit',
	...
	'Your booking will be binding.' => 'Ihre Buchung wird eingetragen.',
    'Your booking will be binding, however, you can cancel it up to %s before it takes place.'
        => 'Ihre Buchung wird eingetragen. Sie können sie jedoch bis zu %s vorher stornieren.',
    ...
    'Consider our additional offers:' => 'Auswahl weiterer Optionen:',
    'per item' => 'pro Stück',
    ...
    'You can %slogin%s or %sregister%s, %s to book this %s' => 'Wenn Sie sich %sanmelden%s, %s können Sie diesen %s buchen',
    ...
    'Ball machine (already booked)' => 'Ballmaschine (bereits reserviert)',
