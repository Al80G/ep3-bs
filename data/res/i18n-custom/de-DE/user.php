...
return array(
    ...
    'You have no permission for this' => 'Sie haben keine Berechtigung dafür',

    'Forgot password?' => 'Passwort vergessen?',
    'Forgot your password?' => 'Passwort vergessen?',
	'Reset Password here' => 'Passwort hier zurücksetzen',

    'We have just received your request to reset your password.' => 'Wir haben gerade Ihre Anfrage zum Zurücksetzen Ihres Passworts erhalten.',
    'Unfortunately, your account is considered a placeholder and thus cannot login.' => 'Leider wurde Ihr Benutzerkonto als Platzhalter definiert und kann sich daher nicht anmelden.',
    ...
    'Simply visit the following website to type your new password:' => 'Besuchen Sie einfach nur die folgende Webseite und geben Ihr neues Passwort ein:',
    'However, you are using a privileged account. For safety, you cannot reset your password this way. Please contact the system support.'
        => 'Allerdings besitzen Sie ein Benutzerkonto mit besonderen Rechten. Aus Sicherheitsgründen können Sie Ihr Passwort daher nicht auf diesem Wege ändern. Kontaktieren Sie uns bitte.',
    'Unfortunately, your account seems somewhat unique, thus we are unsure how to treat it. Mind contacting us?'
        => 'Leider haben wir ein paar technische Probleme mit Ihrem Benutzerkonto. Bitte kontaktieren sie uns.',

    'All right, you should receive an email from us soon' => 'Sie sollten in Kürze eine E-Mail von uns erhalten',
    ...
    'All right, your password has been changed. You can now log into your account.'
        => 'Ihr Passwort wurde geändert. Sie können sich nun wieder anmelden.',
    ...
    'Unfortunately, your account is considered a placeholder and thus cannot be activated.' => 'Leider wurde Ihr Benutzerkonto als Platzhalter definiert und kann daher nicht aktiviert werden.',
    "Before you can completely use your new user account to book spare %s online, you have to activate it by simply clicking the following link. That's all!\r\n\r\n%s"
        => "Bevor Sie nun freie %s online buchen können, müssen Sie nur noch folgendem Link folgen um Ihr Benutzerkonto zu aktivieren und schon können Sie loslegen!\r\n\r\n%s",
    ...
    'Due to too many login attempts, temporarily blocked until %s' => 'Aufgrund zu vieler Anmeldeversuche wurde ihr Account gesperrt bis %s',
    'This account is considered a placeholder and thus cannot login' => 'Leider wurde dieses Benutzerkonto als Platzhalter definiert und kann sich daher nicht anmelden.',
    ...
    'Both email addresses must be identical' => 'Die beiden E-Mail Adressen müssen übereinstimmen',
    'Both passwords must be identical' => 'Die beiden Passwörter müssen übereinstimmen',
    ...
    'No need to be sad. You may simply type your email address here and you will soon be able to choose a new password.'
        => 'Geben Sie hier Ihre E-Mail Adresse ein und wir senden Ihnen eine E-Mail zum Zurücksetzen Ihres Passwortes zu.',
    ...
    'You probably guessed it: To use our service, that is to book spare %s online, you need to create your own user account first.'
        => 'Um unser Angebot nutzen zu können, also um freie %s online buchen zu können, müssen sie Mitglied sein und benötigen ein eigenes Benutzerkonto.',
    'The registration is of course free of cost and nonbinding.' => 'Bitte kontaktieren sie uns für eine Mitgliedschaft und eine Registrierung.',
	...
	'Please do not forget to pay'  => 'Bitte nicht vergessen zu bezahlen',
